...
(function () {
  ...
  const en = {
    ...
    menu: {
      ...
      export: "⬇ Export (JSON)", import: "⬆ Import", pair: "⇄ Pair devices", install: "📲 Install app",
    ...
    conn: { connected: "● Live: {name}", disconnected: "Not connected", live: "Synced ✓" },
    toast: {
  ...
  const de = {
    ...
    menu: {
      ...
      export: "⬇ Export (JSON)", import: "⬆ Import", pair: "⇄ Geräte koppeln", install: "📲 App installieren",
    ...
    conn: { connected: "● Live: {name}", disconnected: "Nicht verbunden", live: "Synchronisiert ✓" },
    toast: {
